...
==================================*/
	...
	// L4D/L4D2 -- Kills
// Commons
$language_pack['kills_commons'] = "Zombiet";
$language_pack['kills_commons_title'] = "Zombieita tapettu";

// Hunters
$language_pack['kills_hunters'] = "Hunters";
$language_pack['kills_hunters_title'] = "Huntereita tapettu";

// Boomers
$language_pack['kills_boomers'] = "Boomers";
$language_pack['kills_boomers_title'] = "Boomereita tapettu";

// Smokers
$language_pack['kills_smokers'] = "Smokers";
$language_pack['kills_smokers_title'] = "Smokereita tapettu";

// Chargers
$language_pack['kills_chargers'] = "Chargers";
$language_pack['kills_chargers_title'] = "Chargereita tapettu";

// Jockeys
$language_pack['kills_jockeys'] = "Jockeys";
$language_pack['kills_jockeys_title'] = "Jockeytä tapettu";

// Spitters
$language_pack['kills_spitters'] = "Spitters";
$language_pack['kills_spitters_title'] = "Spittereitä tapettu";
...
$language_pack['kills_dem_1_title'] = "Selviytyjiä vahingoitettu";

// Incapacitated Friendlies
$language_pack['kills_dem_2'] = "Saattanut toimintakyvyttömäksi omia";
$language_pack['kills_dem_2_title'] = "Selviytyjiä saatettu toimintakyvyttömäksi";

// Teammates Killed
$language_pack['kills_dem_3'] = "Tappanut omia";
$language_pack['kills_dem_3_title'] = "Selviytyjiä tapettu";

// Friendlies Left For Dead
$language_pack['kills_dem_4'] = "Jättänyt omia kuolemaan";
$language_pack['kills_dem_4_title'] = "Selviytyjiä jätetty kuolemaan";
...
$language_pack['tpl_noplyonline'] = "Ei yhtään pelaajaa linjoilla";

/* ---------------------------------------------------------- */

// search.php
$language_pack['tpl_search_title'] = "Pelaajahaku";
$language_pack['tpl_search_nomatch'] = "Ei yhtään pelaajaa löytynyt!";
...
$language_pack['tpl_award_lastupdate'] = "Ansiot päivitetty viimeksi";

/* ---------------------------------------------------------- */

// maps.php
$language_pack['tpl_maps_title'] = "Kampanjoiden tilastot";

/* ---------------------------------------------------------- */

// timedmaps.php
$language_pack['tpl_tmaps_title'] = "Karttojen ajat";
...
$language_pack['tpl_playtime_ply'] = "Pelaaja";
$language_pack['tpl_playtime_plyrank'] = "Sija";
$language_pack['tpl_playtime_plypoints'] = "Pisteet";
$language_pack['tpl_playtime_plytime'] = "Peliaika";
$language_pack['tpl_playtime_plyonline'] = "Viimeksi linjoilla";
...
$language_pack['tpl_layout_top10'] = "Kärki-10 pelaajat";
$language_pack['tpl_layout_search'] = "Etsi <b>pelaajan nimeä</b> tai <b>Steam ID:tä</b>";
$language_pack['tpl_layout_search_btn'] = "Hae";

$language_pack['tpl_layout_plyonline'] = "Pelaajia linjoilla";
$language_pack['tpl_layout_plyrank'] = "Pelaaja tilastot";
$language_pack['tpl_layout_plysearch'] = "Pelaajahaku";
...
// players.tpl
$language_pack['tpl_player_surv'] = "Selviytyjän ansiot";
...
$language_pack['tpl_player_id3'] = "Peliaika:";
$language_pack['tpl_player_id4'] = "Karttojen ajastuksia:";
$language_pack['tpl_player_id_title1'] = "Pelaajan tilastot";
$language_pack['tpl_player_id_title2'] = "Pelaajan tiedot";

// players.tpl
$language_pack['tpl_player_id3_tip'] = "Peliaika:";

/* ---------------------------------------------------------- */

// player_stats.php
$language_pack['tpl_player_stats'] = "Pelaajan tilastot";
$language_pack['tpl_player_stats_sub'] = "Saavutuksia";
...
$language_pack['xml_ply_sum'] = "Ei annettuja tietoja.";

	// Current Player Name
$language_pack['xml_ply_nam'] = "Nykyinen nimi:";

	// Profile Private
$language_pack['xml_ply_private'] = "Tämä profiili on yksityinen.";
