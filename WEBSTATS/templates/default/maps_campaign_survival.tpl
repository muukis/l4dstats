<table class="stats">
<tr><th><?php echo $language_pack['mapname']; ?></th><th><?php echo $language_pack['playtime']; ?></th><th><?php echo $language_pack['pointsppm']; ?></th><th><?php echo $language_pack['kills']; ?></th><th>Plays</th></tr>
<?php
