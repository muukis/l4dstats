		<!-- player.pl -->
			<div class="profile_header_content">
				...
				<div class="profile_header_base">
					...
					<div class="information">
						<div class="box">
							<h2><?php echo $language_pack['tpl_player_id_title2'];?></h2>
							<div class="dt">
								<dt>
									<tr><?php echo $language_pack['tpl_player_id2'];?></tr>
									<tr><?php echo $player_steamid;?></tr>
								</dt>
								<dt  onmouseover="showtip('<b><?php echo $language_pack['tpl_player_id3_tip'];?></b><br>&nbsp;&nbsp;Coop: <?php echo $player_playtime_coop;?><br><?php echo $player_playtime_realism;?>&nbsp;&nbsp;Survival: <?php echo $player_playtime_survival;?><br>&nbsp;&nbsp;Versus: <?php echo $player_playtime_versus;?><?php echo $player_playtime_scavenge;?>');" onmouseout="hidetip();">
									<tr><?php echo $language_pack['tpl_player_id3'];?></tr>
									<tr><?php echo $player_playtime;?></tr>
								</dt>
								<dt>
									<tr><?php echo $language_pack['tpl_player_id4'];?></tr>
						...
						<div class="box">
							<h2><a href="player_stats.php?steamid=<?php echo $player_steamid;?>"><?php echo $language_pack['tpl_player_id_title1'];?></a></h2>
							<div class="dt">
								...
								<dt>
									<tr><?php echo $language_pack['tpl_player_id1'];?></tr>
									<tr>
			...
			<div class="profile_content">
					<div class="awards-base">
						<div class="box">
							<h2><?php echo $language_pack['tpl_player_surv'];?></h2>
							<div class="dt">
					...
					<div class="awards-base2">
						<div class="box">
							<h3><?php echo $language_pack['tpl_player_infe'];?></h3>
							<div class="dt">
