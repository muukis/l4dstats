				...
				<div class="profile_header_base">
					...
					<?php echo "
						<img src='sig.php?steamid=" . $player_steamid . "' />";
						 echo '
						<input class="box_pre" type="text" id="sig_select" readonly value="[URL='. $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] . '][IMG]'. $_SERVER['HTTP_HOST'] .'/sig.php?steamid=' . $player_steamid . '[/IMG][/URL]">
