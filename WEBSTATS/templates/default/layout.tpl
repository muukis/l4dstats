...
<div id="header">
	...
	<div id="logo">
		...
		<?php foreach ($template_selector as $template_path => $template_name): ?>
		<h2><?php echo $template_path;?>: <?php echo $template_name;?></h2>
		<?php endforeach; ?>
		<br>Current Template: <?php echo $current_template;?>
	</div>
