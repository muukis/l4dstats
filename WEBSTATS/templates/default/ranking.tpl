...
<tr><th><?php echo $language_pack['tpl_playtime_plyrank'] ?></th><th><?php echo $language_pack['tpl_playtime_ply'] ?></th><th><?php echo $language_pack['tpl_playtime_plypoints'] ?></th><th><?php echo $language_pack['tpl_playtime_plytime'] ?></th><th><?php echo $language_pack['tpl_playtime_plyonline'] ?></th></tr>
