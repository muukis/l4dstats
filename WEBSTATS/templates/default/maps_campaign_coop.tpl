<table class="stats">
<tr><th><?php echo $language_pack['mapname']; ?></th><th><?php echo $language_pack['playtime']; ?></th><th><?php echo $language_pack['pointsppm']; ?></th><th>Kills</th><th><?php echo $language_pack['restarts']; ?></th></tr>
<?php
