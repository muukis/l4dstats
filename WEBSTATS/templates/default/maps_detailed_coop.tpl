<table class="stats">
<tr><th><?php echo $language_pack['difficulty']; ?></th><th><?php echo $language_pack['playtime']; ?></th><th><?php echo $language_pack['pointsppm']; ?></th><th><?php echo $language_pack['kills']; ?></th><th><?php echo $language_pack['restarts']; ?></th></tr>
