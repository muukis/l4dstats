							...
							<?php else: ?>
								<div class="row">
									...
									<div class="field">
										...
										<?php elseif ( $field['type'] == 'text_hidden' ): ?>
											<input type="text" id="field_<?php echo $field['name']; ?>" style="display:none;" name="<?php echo $field['name']; ?>" value="<?php echo isset($field['value']) ? htmlentities($field['value'], ENT_QUOTES, 'UTF-8') : ''; ?>" <?php echo $this->parse_attributes(isset($field['attributes']) ? $field['attributes'] : array(), array('class' => 'text')); ?> />
										<?php elseif ( $field['type'] == 'text_pass' ): ?>
											<input type="text" id="field_<?php echo $field['name']; ?>" type="password" name="<?php echo $field['name']; ?>" value="<?php echo isset($field['value']) ? htmlentities($field['value'], ENT_QUOTES, 'UTF-8') : ''; ?>" <?php echo $this->parse_attributes(isset($field['attributes']) ? $field['attributes'] : array(), array('class' => 'text')); ?> />
